...
const maintenanceTypes = [
  { id: 'preventive', name: 'Preventive', description: 'Scheduled routine maintenance', icon: Calendar },
  { id: 'corrective', name: 'Corrective', description: 'Fix known issues', icon: Wrench },
  { id: 'predictive', name: 'Predictive', description: 'AI-recommended maintenance', icon: AlertTriangle },
  { id: 'emergency', name: 'Emergency', description: 'Urgent repairs needed', icon: AlertTriangle },
]

const priorityLevels = [
  { id: 'low', name: 'Low', color: 'text-blue-600 bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400' },
  { id: 'medium', name: 'Medium', color: 'text-yellow-600 bg-yellow-100 dark:bg-yellow-900/20 dark:text-yellow-400' },
  { id: 'high', name: 'High', color: 'text-orange-600 bg-orange-100 dark:bg-orange-900/20 dark:text-orange-400' },
  { id: 'critical', name: 'Critical', color: 'text-red-600 bg-red-100 dark:bg-red-900/20 dark:text-red-400' },
]
