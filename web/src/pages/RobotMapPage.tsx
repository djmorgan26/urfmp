  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col">
      ...
      <div className="flex-1 relative">
        ...
        <div
          className={cn(
            'absolute top-2 sm:top-4 left-2 sm:left-4 lg:left-4 rounded-lg shadow-lg backdrop-blur-sm border z-20 lg:z-[70] max-w-[calc(100vw-1rem)] sm:max-w-xs pointer-events-auto',
