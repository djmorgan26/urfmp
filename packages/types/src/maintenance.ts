...
export interface MaintenancePrediction {
  ...
  remainingUsefulLife: number // days or hours depending on type
...
export interface MaintenanceMetrics {
  ...
  maintenanceCostRatio: number // percentage of total operating cost
  complianceScore: number // percentage
  predictiveAccuracy?: number // percentage (for predictive maintenance)
  calculatedAt: Date
}
