...
- Robots: `curl http://localhost:3000/api/v1/robots`
...
- Robot management functionality
...
- ✅ Robot commands, telemetry, and alerts tables (schema ready)
...
4. Add telemetry data collection
...
# API key has permissions: ['robot.view', 'robot.create', 'robot.update', 'robot.delete', 'telemetry.view']
...
- `/robots/:id` - Individual robot details
