...
const PACKAGES = [
  { name: '@urfmp/types', path: 'packages/types', minCoverage: { lines: 0, functions: 0, branches: 0, statements: 0 } },
  { name: '@urfmp/sdk', path: 'packages/sdk', minCoverage: { lines: 25, functions: 15, branches: 25, statements: 25 } },
  { name: '@urfmp/api', path: 'services/api', minCoverage: { lines: 70, functions: 70, branches: 70, statements: 70 } },
  { name: '@urfmp/web', path: 'web', minCoverage: { lines: 75, functions: 75, branches: 75, statements: 75 } }
];
