...
function validateTestInfrastructure() {
  ...
  results.push(runCommand('npm ls --workspaces', 'Verify workspace integrity', { allowFailure: true }));
  ...
  results.push(runCommand('npm run test:coverage --workspace=@urfmp/api', 'API package tests', { allowFailure: true }));
  results.push(runCommand('npm run test --workspace=@urfmp/web', 'Web package tests', { allowFailure: true }));
  ...
  results.push(runCommand('npm run build --workspace=@urfmp/web', 'Web build validation', { allowFailure: true }));
